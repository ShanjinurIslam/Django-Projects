...
def createtodo(request):
    if (request.method=='GET'):
        ...
        try:
            ...
            return render(request,'todo/createtodo.html',{'form':TodoForm(),'error':'Invalid Value'})
@login_required
def viewtodo(request,todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request,'todo/details.html',{'todo':todo,'form':form,'error':'Invalid Value'})
@login_required
